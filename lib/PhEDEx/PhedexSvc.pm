...
our $_bquery = qq|https://cmsweb.cern.ch/phedex/datasvc/perl/prod|;
...
1;
__END__
my $svc = PhEDEx::PhedexSvc->new({ verbose => 1 });
...
PhEDEx::PhedexSvc - Queries the PhEDEx data service to prepare a list of blocks/files PhEDEx believes a site should have
...
that should be available at the site according to PhEDEx. PhEDEx::PhedexSvc fetches all such information and 
